...
import com.google.kpierudzki.driverassistant.ecoDriving.service.EcoDrivingGpsBasedManager;
import com.google.kpierudzki.driverassistant.ecoDriving.service.EcoDrivingObdBasedManager;
import com.google.kpierudzki.driverassistant.geoSamples.service.GeoSamplesManager;
...
public class AssistantServiceManagerHelper implements IDestroyable, IConnectorSelectable {
    ...
    private void prepareEcoDrivingGpsBasedMng(GeoSamplesManager geoSamplesMng) {
        EcoDrivingGpsBasedManager ecoDrivingGpsMng = new EcoDrivingGpsBasedManager(geoSamplesMng);
    ...
    private void prepareObdProbesRecordMng(Context context) {
        DebugObdProbesRecordingManager dbgObdProbesRecMng = new DebugObdProbesRecordingManager();
    ...
    private void prepareEcoDrivingObdBasedMng(ObdManager obdMng) {
        EcoDrivingObdBasedManager ecoDrivingObdMng = new EcoDrivingObdBasedManager(obdMng);
