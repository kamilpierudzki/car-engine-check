...
public class GlobalConfig {
    ...
    public static double ECO_DRIVING_GPS_OPTIMAL_ACCELERATION_LIMIT = 0.000_000_8f;
    public static double ECO_DRIVING_OBD_OPTIMAL_ACCELERATION_LIMIT = 0.000_001f;
}
