package com.google.kpierudzki.driverassistant.ecoDriving.database;
...
public class EcoDrivingEntity {
    ...
    public final static String CURRENT_ACCELERATION_COL_MPMS2 = "current_acceleration";//[m/ms^2]
    ...
    @ColumnInfo(name = EcoDrivingEntity.CURRENT_ACCELERATION_COL_MPMS2)
    ...
    public EcoDrivingEntity(GeoSamplesSwappableData data, float currentAcceleration, int currentScore, float generalScore) {
