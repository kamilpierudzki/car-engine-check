...
public interface EcoDrivingContract {
    ...
    interface View extends BaseView<Presenter>, EcoDrivingDbUseCase.Callback {
        ...
        void updateGpsState(GpsProviderState state);

        void onDataProviderChanged(EcoDrivingDataProvider provider);
    }

    interface Presenter extends BasePresenter, IEcoDrivingListener, IPermissionRequirable {
    ...
    class EcoDrivingInfo implements Parcelable {
        ...
        public static final Creator<EcoDrivingInfo> CREATOR = new Creator<EcoDrivingInfo>() {
            @Override
