...
public class HistoryMapFragment extends Fragment implements OnMapReadyCallback, HistoryMapContract.View,
        SeekBarManager.ICallbacks, IMenuCreate {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        trackDate.setTimeInMillis(mapInfoModel.startTimeInMillis);
        if (dateLabel != null)
            ...
            if (supportActionBar != null && toolbar != null) {
                if (initialize) {
                    if (mainActivityFragmentsCallbacks != null) {
                        mainActivityFragmentsCallbacks.setUseToolbarNavigationCustomAction(true);
                    }
                    ...
                    if (activity instanceof MainActivity) {
                        ((MainActivity) activity).setMenuCreateObservable(this);
                    }
                } else {
                    ...
                    if (mainActivityFragmentsCallbacks != null) {
                        mainActivityFragmentsCallbacks.setUseToolbarNavigationCustomAction(false);
                    }
                    ...
                    if (activity instanceof MainActivity) {
                        ((MainActivity) activity).setMenuCreateObservable(null);
                    }
                }
            }
        }
    ...
    @Override
    public boolean onNavigationBack(boolean fromActivity) {
        if (!fromActivity && mainActivityFragmentsCallbacks != null) {
            ((Activity) mainActivityFragmentsCallbacks).onBackPressed();
        }
        return !fromActivity;
    }
}
