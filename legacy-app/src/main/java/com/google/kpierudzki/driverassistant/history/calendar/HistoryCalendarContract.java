...
public interface HistoryCalendarContract {
    ...
    class CalendarTranslateInfoModel implements Parcelable {
        ...
        public CalendarTranslateInfoModel(long trackId, Coordinate startPoint, String startPointTranslation, Coordinate endPoint, String endPointTranslation, long startTimeInMillis, ScoreColor scoreColor, float score) {
        ...
        public CalendarTranslateInfoModel(CalendarTranslateInfoModel model) {
            ...
            this.startTimeInMillis = model.startTimeInMillis;
        ...
        public CalendarTranslateInfoModel clone() {
            return new CalendarTranslateInfoModel(
                    trackId,
                    startPoint,
        ...
        public boolean equals(Object o) {
            ...
            if (startTimeInMillis != that.startTimeInMillis) return false;
        ...
        public static final Creator<CalendarTranslateInfoModel> CREATOR = new Creator<CalendarTranslateInfoModel>() {
            @Override
