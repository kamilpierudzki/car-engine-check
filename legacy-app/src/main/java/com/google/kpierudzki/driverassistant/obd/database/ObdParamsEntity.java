...
public class ObdParamsEntity {
    ...
    public ObdParamsEntity(GeoSamplesSwappableData data, float currentSpeed, float rpm, float coolantTemp, float load, float oilTemp, float maf, float ambientTemp, float barometricPress) {
